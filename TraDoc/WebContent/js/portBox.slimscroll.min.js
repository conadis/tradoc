		...
		return this
				.each(function() {
					...
					if (n.has(".scrollBar").length == 0 && s == true) {
								n
										.wrapInner('<div class="scrollBar" style="padding-right:0;" />'),
								n.css({
									"padding-right" : 0
								});
						e(function() {
							e(".scrollBar").slimScroll({
								height : "100%"
							})
						});
					...
					n.center = function() {
						var t, r;
						if (n.outerHeight() + 25 > e(window).height()
								&& s === true && o === false) {
						...
						n.css({
							top : t + e(window).scrollTop(),
							left : r + e(window).scrollLeft()
						});
					...
					n.on("portBox:close", function() {
						if (!r) {
							...
							if (t.animation == "") {
								...
								i.fadeOut(t.animationspeed), n
										.fadeOut(t.animationspeed);
								u()
							}
					...
					var f = e(".close-portBox").one("click.portBoxEvent",
							function() {
					...
					this
							.each(function() {
								function E(t) {
									...
									if (e(s).closest("." + r.wrapperClass).is(
											v.parent())) {
										S(i, true)
									}
								...
								function S(e, t, n) {
									...
									if (t) {
										i = parseInt(b.css("top")) + e
												* parseInt(r.wheelStep) / 100
												* b.outerHeight();
										i = Math.min(Math.max(i, 0), s);
										i = e > 0 ? Math.ceil(i) : Math
												.floor(i);
										b.css({
											top : i + "px"
										})
									}
									l = parseInt(b.css("top"))
											/ (v.outerHeight() - b
													.outerHeight());
									i = l
											* (v[0].scrollHeight - v
								...
								function T() {
									f = Math.max(v.outerHeight()
											/ v[0].scrollHeight
											* v.outerHeight(), p);
									b.css({
										height : f + "px"
									});
									var e = f == v.outerHeight() ? "none"
											: "block";
									b.css({
										display : e
									})
								...
								r.height = r.height == "auto" ? v.parent()
										.innerHeight() : r.height;
								var g = e(h).addClass(r.wrapperClass).css({
									position : "relative",
									overflow : "hidden",
									width : r.width,
									height : r.height
								...
								var y = e(h).addClass(r.railClass).css(
										{
											width : r.size,
											height : "80%",
											position : "absolute",
											top : 0,
											display : r.alwaysVisible
													&& r.railVisible ? "block"
													: "none",
								...
								var b = e(h).addClass(r.barClass).css(
										{
											background : r.color,
											width : r.size,
											position : "absolute",
										...
										.bind(
												...
												function(e) {
													e.originalEvent
															.preventDefault();
													if (e.originalEvent.touches.length) {
														var t = (a - e.originalEvent.touches[0].pageY)
																/ r.touchScrollStep;
														S(t, true)
													}
												});
